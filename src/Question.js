...
export default function Question(props) {
    ...
    const allAnswers = React.useRef(_.shuffle(incorrectAnswers.concat(correctAnswer)));
    ...
    function handleStyleChange(index) {
        ...
        if(selectedAnswerIndex !== undefined || !props.isValidTime) {
            ...
            const isSelectedAnswerCorrect = allAnswers.current[selectedAnswerIndex] === correctAnswer;
        ...
        <div className='question-answer-layout'>
            ...
            <div className='answers-list'>
                {allAnswers.current.map((answer, index) => {
                    ...
                    return <button disabled={disabled || !props.isValidTime} className={'answer ' + resultClass} key={"answer" + index} onClick={
