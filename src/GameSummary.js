            ...
            <div className="end-game-popup">
                        ...
                        <table className="table">
                            ...
                            <tbody>
                                {props.leaderboardData.map((row, index) => {
                                    ...
                                    let rowClass = props.currentDocId.current === row.id ? "active-row" : "";
                                    ...
                                    return <tr key={row.id} className={rowClass}>
                                        ...
                                        <td>
                                            <div className="little-circle">
                                                <img src={listOfImgs[row.avatar_index][0]} alt={listOfImgs[listOfImgs[row.avatar_index][1]]}/>
                                            </div>
                                        </td>
                ...
                <div className="summary-section">
                    <div className="player-info">
                        <div className="player-circle"><img src={listOfImgs[props.gameDetails.avatar_index][0]} alt={listOfImgs[props.gameDetails.avatar_index][1]}/></div>
                    ...
                    <div className="buttons">
                        <button><i className="material-symbols-rounded">replay</i>Play again</button>
                        <button onClick={props.onExit} className="secondary">Exit</button>
                    </div>
                </div>
