...
export default function App() {
    ...
    function showNavigation () {
        if(currentPage === 'home' || currentPage === 'how-it-works' || currentPage === 'start-trivia') {
    ...
    <a href="#main" className="skip-to-main"><span className="skip">Skip to Content</span></a>
    ...
    <header>
      {showNavigation()}
       ...
       {currentPage === 'home' && <Home onNavigateCallback={navigateFromHome}/>}
        ...
        {currentPage === 'how-it-works' && <HowItWorks onNavigateCallback={navigate}/>}

        {currentPage === 'start-trivia' && <StartTrivia entryInfo={homeNavigationInfo} onNavigateCallback={navigate} onStartGameCallback={onGameStart} onFetchDataCallback={updateData}/>}

        {currentPage === 'game' && <Game gameDetails={gameInfo} exit={navigate} questionData={questionsData} />}
        {/* onGameEnd={onGameEnd} */}
